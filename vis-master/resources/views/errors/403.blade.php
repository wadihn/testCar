...
<head>
    ...
    <title>403 — {{ $lang === 'ar' ? 'غير مصرّح' : 'Forbidden' }}</title>
...
<body>
    <div>
        ...
        <div class="title">{{ $lang === 'ar' ? 'غير مصرّح لك' : 'Access Forbidden' }}</div>
        <div class="desc">{{ $lang === 'ar' ? 'ما عندك صلاحية للوصول لهاي الصفحة. تواصل مع المسؤول.' : 'You do not have permission to access this page. Contact your administrator.' }}</div>
